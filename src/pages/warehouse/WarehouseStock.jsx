...
export default function WarehouseStock({ token, onNavigate = () => {}, onCreate, initialToast = '', selectedReceiptId, onCloseReceipt = () => {} }) {
